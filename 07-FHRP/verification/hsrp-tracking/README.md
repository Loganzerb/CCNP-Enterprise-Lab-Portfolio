# HSRP upstream tracking and recovery

Untracked upstream failure, effective-priority reduction, alternate forwarding, and recovery ordering with and without preemption delay. Packet loss remains visible in the original captures.
