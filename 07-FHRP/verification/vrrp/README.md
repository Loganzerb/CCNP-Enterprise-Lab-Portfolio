# VRRP election, tracking, and recovery

VLAN 20 Master/Backup election, interface failure, tracked priority reduction, and recovery ordering relative to OSPF. These captures cover different experiment stages.
